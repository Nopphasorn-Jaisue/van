...
const scheduleTemplates: EventTemplate[] = [
  { day: 2, startHour: 7, durationHours: 10, facultyId: 'ict', destination: 'เชียงใหม่', vanCode: 'Van 12', status: 'approved', scope: 'outbound', vansInUse: 1 },
  { day: 3, startHour: 8, durationHours: 8, facultyId: 'agri', destination: 'แพร่', vanCode: 'Van 01', status: 'approved', scope: 'local', vansInUse: 1 },
  { day: 5, startHour: 9, durationHours: 6, facultyId: 'med', destination: 'รพ.พะเยา', vanCode: 'Van 05', status: 'shared', scope: 'outbound', vansInUse: 1 },
  ...
  { day: 12, startHour: 8, durationHours: 8, facultyId: 'law', destination: 'ศาลจังหวัดพะเยา', vanCode: 'Van 09', status: 'approved', scope: 'local', vansInUse: 1 },
  { day: 15, startHour: 6, durationHours: 14, facultyId: 'bca', destination: 'กรุงเทพฯ', vanCode: 'Van 08', status: 'shared', scope: 'outbound', vansInUse: 1 },
  ...
  { day: 21, startHour: 10, durationHours: 6, facultyId: 'med', destination: 'รพ.พะเยา', vanCode: 'Van 05', status: 'shared', scope: 'outbound', vansInUse: 1 },
  { day: 21, startHour: 7, durationHours: 12, facultyId: 'law', destination: 'ศาลเชียงราย', vanCode: 'Van 11', status: 'pending', scope: 'outbound', vansInUse: 1 },
  
  { day: 23, startHour: 8, durationHours: 5, facultyId: 'bca', destination: 'กรุงเทพฯ', vanCode: 'Van 08', status: 'approved', scope: 'local', vansInUse: 1 },
  
  // วันที่คิวล้น (Over 4 events to trigger "+ อีก X รายการ" in month view)
  { day: 25, startHour: 8, durationHours: 10, facultyId: 'dent', destination: 'ศูนย์ซ่อมมหาวิทยาลัย', vanCode: 'Van 14', status: 'maintenance', scope: 'maintenance', vansInUse: 1 },
  ...
  { day: 26, startHour: 7, durationHours: 11, facultyId: 'libarts', destination: 'เชียงใหม่', vanCode: 'Van 15', status: 'shared', scope: 'outbound', vansInUse: 1 },
  { day: 28, startHour: 9, durationHours: 8, facultyId: 'education', destination: 'เครือข่ายโรงเรียนจังหวัดพะเยา', vanCode: 'Van 16', status: 'approved', scope: 'local', vansInUse: 1 },
];
...
const todayTemplates: Array<{ startHour: number; facultyId: string; destination: string; vanCode: string }> = [
  ...
  { startHour: 9, facultyId: 'med', destination: 'เดินทางไป รพ.พะเยา', vanCode: 'Van 05' },
...
export function buildFallbackNetworkEvents(
  ...
  return scheduleTemplates.map((template) => {
    ...
    return {
      id: `${template.facultyId}-${template.day}`,
